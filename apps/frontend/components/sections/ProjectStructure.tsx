      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div>
          ...
          <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
            By separating concerns into distinct apps and packages, Sketch Collab maintains a strictly typed boundary between the frontend UI, the real-time drawing server, and the database layer.
          </p>
        </div>
